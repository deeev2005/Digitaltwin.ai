                ...
                <div className="max-w-[500px] mx-auto">
                  ...
                  >
                    <div className="space-y-2">
                      <p className="text-[12px] text-muted-foreground leading-relaxed">
                        Precision/recall evaluated continuously over 10,000 takt cycles against confirmed physical quality logs.
                      </p>
          ...
          <Panel>
            ...
            <div className="p-5 space-y-6">
              <p className="text-[13px] text-muted-foreground leading-relaxed">
                How the Digital Twin computes defensible risk estimates at un-instrumented or sensor-poor stations using direct physical bracketing from adjacent stations, proxy events, and historical baselines.
              </p>
              ...
              <div className="max-w-[760px] mx-auto py-2 space-y-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[760px] mx-auto">
                  ...
                  <ValidationFlowNode
                    ...
                    subtitle="Un-instrumented Station Gate"
                    badge="Gap Detected"
                    tone="warn"
