        ...
        <div className="relative w-full max-w-[1240px] mx-auto py-2">
          ...
          <div className="relative w-full">
              ...
              >
                <div className="space-y-2.5 text-[11px]">
                  ...
                  <div className="space-y-1.5 text-[10.5px] leading-snug text-foreground/90 pt-1">
                    ...
                    <div>
                      <strong className="text-purple-300">Prescribed Intervention:</strong> Buffer hold at ST-21 for re-torque verification + recalibrate nutrunner during shift change.
                    </div>
                  </div>
                </div>
              </FlowNode>
            ...
            <div className="mt-4 lg:mt-0 lg:absolute lg:right-0 lg:top-0 lg:w-[250px] xl:w-[270px]">
              ...
              <div className="hidden lg:block absolute -left-8 xl:-left-16 top-7 w-8 xl:w-16 h-[2px] pointer-events-none z-10">
                <svg className="w-full h-full overflow-visible" preserveAspectRatio="none">
                  ...
                  <path d="M 5 -3 L 0 0 L 5 3" fill="none" stroke="#818CF8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <div className="space-y-2 text-[11px]">
                ...
                <div className="rounded-lg border border-rose-500/50 bg-rose-950/25 p-2 space-y-1">
                  ...
                  <div className="text-[10px] text-muted-foreground leading-snug">
                    Hold in Station 21 buffer for re-torque verification before paint bake.
                  </div>
                  ...
                  <div className="space-y-2 text-[10.5px] leading-snug text-foreground/90">
                    ...
                    <div className="space-y-1.5 pt-0.5">
                      ...
                      <div>
                        ...
                        <span className="text-muted-foreground leading-relaxed">
                          "Hold this vehicle before it reaches Powertrain Marriage (Station 28) and re-verify the subframe torque now at Station 21 buffer, while it's still a simple re-torque — waiting until Station 28 turns this into a full line halt."
                        </span>
                      </div>
                    </div>
                  </div>
    ...
    <Panel className="border-border/80 shadow-md overflow-hidden">
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="max-w-[620px] mx-auto">
          ...
          {/* GenAI Analytical Role Caption */}
          <p className="mt-1.5 text-center font-mono text-[10px] text-muted-foreground italic px-3 leading-tight">
            "GenAI performs no calculation of its own — it synthesizes and explains what SPC, ML, and aggregation logic have already computed."
          </p>
        </div>
              ...
              <div className="space-y-2 text-[11px] leading-snug">
                ...
                <div className="space-y-1.5 pt-0.5 text-foreground/90">
                  ...
                  <div>
                    <strong className="text-purple-300">Recommended Action: </strong>
                    <span className="text-muted-foreground leading-relaxed">
                      "Hold this vehicle before Powertrain Marriage (ST-28) for a manual re-torque check — this is a simple fix now, but becomes a full disassembly if left until ST-28."
                    </span>
                  </div>
                </div>
              </div>
