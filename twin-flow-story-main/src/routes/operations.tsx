              ...
              <div className="p-5 space-y-6">
                ...
                <div className="rounded-xl border border-purple-500/40 bg-panel-raised/80 p-5 space-y-4">
                  ...
                  <p className="text-[13px] text-foreground/90 leading-relaxed">
                    Route VIN <strong>7HGB…9321</strong> to Inspection Bay B upon leaving Paint Booth ST-21. Perform manual retorque check on 6 subframe bolts. Recalibrate Nutrunner T14 during 14:00 shift change.
                  </p>
              ...
              <div className="p-5 space-y-6">
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  <div className="p-4 rounded-xl border border-emerald-500/40 bg-emerald-950/20 space-y-1">
                    ...
                    <p className="text-[11.5px] text-muted-foreground">Prevented teardowns & yard recalls</p>
                  </div>
